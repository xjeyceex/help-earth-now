            ...
            <main className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-200 py-16 px-6">
                <section className="max-w-7xl mx-auto space-y-12">
                    ...
                    <div className="bg-white shadow-xl rounded-lg p-10 transition-transform transform hover:scale-105 duration-300 dark:bg-gray-700">
                        <h2 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Who We Are</h2>
                    ...
                    {/* Our Mission Section */}
                    <div className="bg-white shadow-xl rounded-lg p-10 transition-transform transform hover:scale-105 duration-300 dark:bg-gray-700">
                        <h2 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Our Mission</h2>
                        <p className="text-lg leading-8 text-gray-600 dark:text-gray-300 mb-6">
                    ...
                    {/* What We Do Section */}
                    <div className="bg-white shadow-xl rounded-lg p-10 transition-transform transform hover:scale-105 duration-300 dark:bg-gray-700">
                        <h2 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-gray-100">What We Do</h2>
                        <p className="text-lg leading-8 text-gray-600 dark:text-gray-300 mb-6">
                    ...
                    {/* Our Values Section */}
                    <div className="bg-white shadow-xl rounded-lg p-10 transition-transform transform hover:scale-105 duration-300 dark:bg-gray-700">
                        <h2 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Our Values</h2>
