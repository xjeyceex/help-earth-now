            ...
            <main className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-200 py-8 px-6">
                <section className="max-w-7xl mx-auto space-y-12">
                    ...
                    <div className="bg-gradient-to-r from-green-400 to-blue-500 shadow-xl rounded-lg p-10 text-center text-white transition-transform transform hover:scale-105 duration-300">
                        ...
                        Ready to make a difference? 🌱  Connect with us on your favorite Social Media and tell your friends about us!   Whether you&apos;re a seasoned climate warrior or just getting started, we need you.  Let&apos;s build a greener future, one action at a time!  And hey, we promise, no guilt trips — just actionable steps and good vibes.
                        </p>
                    </div>
                </section>
            </main>
