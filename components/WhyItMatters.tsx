...
const WhyItMatters: React.FC = () => {
  ...
  const items = [
    ...
    // },
    {
      ...
      title: 'Wildfires',
      description:
        'Increasing temperatures have led to more frequent and intense wildfires, devastating forests and wildlife, and endangering human lives.',
      moreInfo:
        'Wildfires are exacerbated by climate change, leading to more severe damage to ecosystems and releasing significant amounts of CO2 into the atmosphere, worsening global warming. These fires threaten air quality, contribute to respiratory diseases, and force communities to evacuate, resulting in economic losses and long-term psychological impacts on affected populations.',
    ...
    },
    {
      ...
      title: 'Droughts',
      description:
        'Prolonged droughts are becoming more common, threatening food and water supplies for millions of people, causing economic and social instability.',
      moreInfo:
        'Droughts have far-reaching consequences on agriculture, drinking water supplies, and food security, leading to famine and displacement in vulnerable regions. The agricultural sector suffers significantly, with crop failures and livestock losses, which can escalate food prices and increase competition for resources, leading to social unrest.',
    ...
    },
    {
      ...
      title: 'Severe Storms',
      description:
        'Climate change is fueling more intense hurricanes, typhoons, and cyclones, causing widespread damage to communities and infrastructure.',
      moreInfo:
        'Warmer ocean temperatures and changing weather patterns are contributing to more powerful and destructive storms, displacing millions and costing billions in damages. The increase in storm frequency and intensity leads to higher insurance premiums, infrastructure repair costs, and long-term displacement for communities, significantly affecting local economies and recovery efforts.',
      learnMore:
        'https://www.climate.gov/news-features/understanding-climate/climate-change-global-sea-level',
    },
    {
      ...
      title: 'Heatwaves',
      description:
        'Intense heatwaves are becoming more intense and prolonged, endangering public health, agriculture, and energy supplies.',
      moreInfo:
        'Extreme heat events cause heat-related illnesses and deaths, strain power grids, and reduce crop yields, exacerbating food insecurity. Vulnerable populations, including the elderly and those with pre-existing health conditions, are at greater risk. The agricultural sector also faces challenges as heat stress on crops reduces yields and quality, impacting food supply and prices.',
      learnMore:
    ...
    },
    {
      ...
      description:
        'The polar ice caps are melting at an alarming rate, contributing to sea level rise and threatening polar ecosystems.',
      moreInfo:
